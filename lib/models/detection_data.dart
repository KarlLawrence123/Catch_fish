  ...
  void addDetection(DetectionData detection) {
    ...
    if (detection.status != 'healthy') {
      final alert = AlertData(
        ...
        title: detection.status == 'disease' ? 'Disease Detected' : 'Suspicious Activity',
        message: '${detection.diseaseName} detected with ${(detection.confidence * 100).toStringAsFixed(1)}% confidence',
