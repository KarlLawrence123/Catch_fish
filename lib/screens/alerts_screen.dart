...
class AlertsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<DetectionProvider>(
        builder: (context, provider, child) {
          final unreadAlerts = provider.alerts.where((alert) => !alert.isRead).toList();
          final readAlerts = provider.alerts.where((alert) => alert.isRead).toList();
                      ...
                      children: [
                        Expanded(
                          child: _buildAlertStat(
                            context,
                            'Critical',
                            unreadAlerts.where((a) => a.severity == 'high').length,
                        ...
                        Expanded(
                          child: _buildAlertStat(
                            context,
                            'Warning',
                            unreadAlerts.where((a) => a.severity == 'medium').length,
                        ...
                        Expanded(
                          child: _buildAlertStat(
                            context,
                            'Info',
                            unreadAlerts.where((a) => a.severity == 'low').length,
  ...
  Widget _buildAlertStat(BuildContext context, String label, int count, Color color) {
    return Container(
  ...
  void _markAsRead(BuildContext context, DetectionProvider provider, String alertId) {
                        ...
                        Expanded(
                          child: Text(
                            ...
                            style: Theme.of(context).textTheme.titleMedium?.copyWith(
                              fontWeight: !alert.isRead ? FontWeight.bold : FontWeight.w600,
                            ),
                            maxLines: 1,
